...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { first_name: @trainer.first_name, full_name: @trainer.full_name, last_name: @trainer.last_name } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { first_name: @trainer.first_name, full_name: @trainer.full_name, last_name: @trainer.last_name } }
